    ...
    <nav className="flex justify-between w-full px-[2em] h-[4.5em]  items-center z-50  fixed mix-blend-difference text-gray ">
      ...
      <div className="nav_link">
        <ul className="uppercase text-[clamp(.5rem,1vw,1.3rem)] flex gap-[1em] ">
          <li  >
            <Link className=" py-[1.5em]" to={"/about"}>[ about me]</Link>
          </li>
          <li>
            <Link className=" py-[1.5em]"  to={"/projects"}>[ projects ]</Link>
          </li>
          <li>
            <Link className=" py-[1.5em]"  to={"/skills"}>[ skills ]</Link>
          </li>
          <li>
            <Link className=" py-[1.5em]"  to={"/connect"}>[ connect ]</Link>
          </li>
        </ul>
      </div>

      <div className="nav_talk">
        <a  href="mailto:hello@vimal.dev" className="flex py-[1.5em] items-center uppercase text-[clamp(.5rem,1vw,1.1rem)] ">
